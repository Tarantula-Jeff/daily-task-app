...
export function TaskItem(props){
    ...
    return<div>
    <li className="flex justify-between gap-4 p-2 rounded-lg shadow-lg my-4 hover:bg-gradient-to-br hover:from-fuchsia-500 hover:to-orange-400 hover:text-white cursor-pointer font-bold  bg-fuchsia-100 text-sm text-fuchsia-900 font-medium">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                   ...
                   }</small></button>
                   {
                    isCompleted &&<button onClick={()=>{
                        ...
                        <small> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="h-4 w-4 rounded-full">
  <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
</svg></small>
                    </button>
